...
class MicropostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create micropost" do
    assert_difference('Micropost.count') do
      post microposts_url, params: { micropost: { content: @micropost.content, user_is: @micropost.user_is } }
    end
  ...
  test "should update micropost" do
    patch micropost_url(@micropost), params: { micropost: { content: @micropost.content, user_is: @micropost.user_is } }
